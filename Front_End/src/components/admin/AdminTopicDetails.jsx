...
import CreateQuizModal from "./subcomponents/CreateQuizModal";
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <CreateLessonModal open={open} handleClose={handleClose} topicId={data?._id} />
       ...
       <CreateQuizModal open={openQuizModal} handleClose={handleCloseQuizModal} topicId={data?._id} />
          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <button
                  type="button"
                  className="flex items-center justify-center text-gray-500 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                onClick={handleOpen}
                >
                  <svg
          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {
                    data?.quiz?.map((qz,index)=>(
                      <tr className="border-b dark:border-gray-700" key={qz._id}>
                      <th
                        scope="row"
                        className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                      >
                      ...
                      <td className="px-4 py-3">{qz.question}</td>
