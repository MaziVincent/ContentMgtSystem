  ...
  return (
    <>
      <div className="w-full">
        ...
        <CreateLearningPathModal open={open} handleClose={handleClose} />
            ...
            <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4 font-medium text-gray-900">Framework</th>
                  <th
                    scope="col"
                    className="px-6 py-4 font-medium text-gray-900"
                  >
              ...
              <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                {data?.map((lp) => (
                  ...
                  <div className="flex gap-2">
                    ...
                    <td className="px-6 py-4">{lp.description}</td>

                    <td className="px-6 py-4">
                      <div className="flex justify-end gap-4">
                        <button
                          x-data="{ tooltip: 'Delete' }"
                          onClick={()=> {handleOpenDeleteModal(); setDeleteId(lp._id)}}
                        >
                          <svg
